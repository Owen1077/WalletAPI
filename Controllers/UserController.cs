...
using WalletTransaction.Authentication.Model;
        ...
        public async Task <IActionResult> Register([FromBody ] RegisterModel model)
        {
            ...
            if (userExists != null)
                return StatusCode(StatusCodes.Status500InternalServerError,
                    new AppResponse { Status = "Error", Message = "User already exists!" });
            ...
            if (!result.Succeeded)
                return StatusCode(StatusCodes.Status500InternalServerError, 
                    new AppResponse { Status = "Error", Message = "User creation failed! Please check user details and try again." });
